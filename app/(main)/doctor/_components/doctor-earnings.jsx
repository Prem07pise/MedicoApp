    ...
    <div className="space-y-6">
      ...
      <Card className="border-emerald-900/20">
        ...
        <CardContent className="space-y-4">
            ...
            {pendingPayout ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                <div>
                  ...
                  <p className="text-blue-900 font-medium">{availableCredits}</p>
                </div>
                <div>
          ...
          {payouts.length > 0 && (
            <div className="space-y-2">
              <h3 className="text-lg font-medium text-stone-900">Payout History</h3>
              <div className="space-y-2">
          ...
          <form onSubmit={handlePayoutRequest} className="space-y-4">
            <div className="bg-muted/20 p-4 rounded-lg space-y-2">
              <div className="flex justify-between">
                ...
                <span className="text-stone-900">{availableCredits}</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-blue-900">-${platformFee.toFixed(2)}</span>
              </div>
              <div className="border-t border-emerald-900/20 pt-2 flex justify-between font-medium">
                <span className="text-blue-900">Net payout:</span>
