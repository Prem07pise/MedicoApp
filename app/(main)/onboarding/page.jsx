  ...
  if (step === "choose-role") {
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card
          className="border bg-gray-300/20 hover:bg-gray-500/40 border-blue-500 cursor-pointer transition-all"
          onClick={() => !loading && handlePatientSelection()}
        >
          <CardContent className="pt-6 pb-6 flex flex-col items-center text-center">
            <div className="p-4 bg-black/20 rounded-full mb-4">
              <User className="h-8 w-8 text-black-400" />
            </div>
            ...
            <Button
              className="w-full mt-2 bg-blue-500 hover:bg-gray-700"
              disabled={loading}
            >
              {loading ? (
                <>
        ...
        >
          <CardContent className="pt-6 pb-6 flex flex-col items-center text-center">
            <div className="p-4 bg-black/20 rounded-full mb-4">
              <Stethoscope className="h-8 w-8 text-black-400" />
            </div>
            <CardTitle className="text-xl font-semibold text-black mb-2">
              Join as a Doctor
            </CardTitle>
        ...
        <CardContent className="pt-6">
          ...
          <form onSubmit={handleSubmit(onDoctorSubmit)} className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="specialty" className="text-stone-900">Medical Specialty</Label>
              <Select
            ...
            <div className="space-y-2">
              <Label htmlFor="experience" className="text-stone-900">Years of Experience</Label>
              <Input
                id="experience"
                type="number"
                placeholder="e.g. 5"
            ...
            <div className="space-y-2">
              <Label htmlFor="credentialUrl" className="text-stone-900">Link to Credential Document</Label>
              <Input
                id="credentialUrl"
                type="url"
            ...
            <div className="space-y-2">
              <Label htmlFor="description" className="text-stone-900">Description of Your Services</Label>
              <Textarea
                id="description"
            ...
            <div className="pt-2 flex items-center justify-between">
              <Button
                ...
                className="bg-pink-500 hover:bg-gray-400"
                disabled={loading}
              >
                Back
              </Button>
              <Button
                type="submit"
                className="bg-blue-500 hover:bg-gray-700"
                disabled={loading}
              >
                {loading ? (
                  <>
